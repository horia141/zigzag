...
class VideoCellView: UITableViewCell, UITableViewDelegate {

    @IBOutlet weak var ContentTable: UITableView!
    private var video_cell_vm: TableCellVM! = nil
...
//        println("init video cell here with subcellsources")
    ...
    func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        var object = video_cell_vm.getSubCellSourceAtIndexPath(indexPath) as CellSource
