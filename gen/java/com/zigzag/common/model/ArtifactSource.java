            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.subdomains = new HashSet<String>(2*_set0.size);
                String _elem1;
                for (int _i2 = 0; _i2 < _set0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.subdomains.add(_elem1);
                }
                iprot.readSetEnd();
              }
      ...
      if (struct.subdomains != null) {
        if (struct.isSetSubdomains()) {
          oprot.writeFieldBegin(SUBDOMAINS_FIELD_DESC);
          {
            ...
            for (String _iter3 : struct.subdomains)
            {
      ...
      if (struct.isSetSubdomains()) {
        {
          ...
          for (String _iter4 : struct.subdomains)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.subdomains = new HashSet<String>(2*_set5.size);
          String _elem6;
          for (int _i7 = 0; _i7 < _set5.size; ++_i7)
          {
            _elem6 = iprot.readString();
            struct.subdomains.add(_elem6);
          }
        }
        struct.setSubdomainsIsSet(true);
      }
